...
MicromegasMapping::MicromegasMapping():
   ...
   */
  // south side
    {5,  {55, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, 4 }, "sec20.0", "R3.1", "M9P",  "SEIP" },
	  {7,  {56, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   4 }, "sec20.1", "R3.2", "M9Z",  "SEIZ" },
	  {6,  {55, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, 0 }, "sec21.0", "R3.3", "M5P",  "SCOP" },
	  {8,  {56, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   0 }, "sec21.1", "R3.4", "M5Z",  "SCOZ" },
	  {9,  {55, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, 1 }, "sec21.2", "R3.5", "M8P",  "SCIP" },
	  {10, {56, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   1 }, "sec21.3", "R3.6", "M8Z",  "SCIZ" },
	  {24, {55, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, 6 }, "sec22.0", "R3.8", "M6P",  "SWIP" },
	  {25, {56, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   6 }, "sec22.1", "R3.8", "M6Z",  "SWIZ" },
	
	  // north side
	  {11, {55, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, 5 }, "sec8.0",  "R2.1", "M2P",  "NEIP" },
	  {12, {56, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   5 }, "sec8.1",  "R2.2", "M2Z",  "NEIZ" },
	  {19, {55, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, 3 }, "sec9.0",  "R2.3", "M10P", "NCOP" },
	  {18, {56, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   3 }, "sec9.1",  "R2.4", "M10Z", "NCOZ" },
	  {0,  {55, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, 2 }, "sec9.2",  "R2.5", "M4P",  "NCIP" },
	  {1,  {56, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   2 }, "sec9.3",  "R2.6", "M4Z",  "NCIZ" },
	  {15, {55, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, 7 }, "sec10.0", "R2.7", "M7P",  "NWIP" },
...
int MicromegasMapping::get_physical_strip( int fee_id, int channel_id) const
{
  ...
  const auto segmentation_type = get_segmentation(fee_id);
