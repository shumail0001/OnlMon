...
MicromegasMapping::MicromegasMapping():
   ...
   */
  // south side
  {5,  MicromegasDefs::SegmentationType::SEGMENTATION_PHI, "sec20.0", "R3.1", "M9P",  "SEIP" },
  {7,  MicromegasDefs::SegmentationType::SEGMENTATION_Z,   "sec20.1", "R3.2", "M9Z",  "SEIZ" },
  {6,  MicromegasDefs::SegmentationType::SEGMENTATION_PHI, "sec21.0", "R3.3", "M5P",  "SCOP" },
  {8,  MicromegasDefs::SegmentationType::SEGMENTATION_Z,   "sec21.1", "R3.4", "M5Z",  "SCOZ" },
  {9,  MicromegasDefs::SegmentationType::SEGMENTATION_PHI, "sec21.2", "R3.5", "M8P",  "SCIP" },
  {10, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   "sec21.3", "R3.6", "M8Z",  "SCIZ" },
  {24, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, "sec22.0", "R3.8", "M6P",  "SWIP" },
  {25, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   "sec22.1", "R3.8", "M6Z",  "SWIZ" },

  {11, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, "sec8.0",  "R2.1", "M2P",  "NEIP" },
  {12, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   "sec8.1",  "R2.2", "M2Z",  "NEIZ" },
  {19, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, "sec9.0",  "R2.3", "M10P", "NCOP" },
  {18, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   "sec9.1",  "R2.4", "M10Z", "NCOZ" },
  {0,  MicromegasDefs::SegmentationType::SEGMENTATION_PHI, "sec9.2",  "R2.5", "M4P",  "NCIP" },
  {1,  MicromegasDefs::SegmentationType::SEGMENTATION_Z,   "sec9.3",  "R2.6", "M4Z",  "NCIZ" },
  {15, MicromegasDefs::SegmentationType::SEGMENTATION_PHI, "sec10.0", "R2.7", "M7P",  "NWIP" },
  {14, MicromegasDefs::SegmentationType::SEGMENTATION_Z,   "sec10.1", "R2.8", "M7Z",  "NWIZ" }
} )
{
