...
int ZdcMonDraw::DrawSmdAdcMeans(const std::string & /* what */)
{
  ...
  smd_adc_n_hor_means = new TH1F("smd_adc_n_hor_means", "SMD ADC for North-Horizontal Channels", 8, 0.5, 8.5);
  smd_adc_s_hor_means = new TH1F("smd_adc_s_hor_means", "SMD ADC for South-Horizontal Channels", 8, 0.5, 8.5);
  smd_adc_n_ver_means = new TH1F("smd_adc_n_ver_means", "SMD ADC for North-Vertical Channels", 7, 0.5, 7.5);
  smd_adc_s_ver_means = new TH1F("smd_adc_s_ver_means", "SMD ADC for South-Vertical Channels", 7, 0.5, 7.5);
