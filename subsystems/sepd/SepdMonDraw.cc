...
int SepdMonDraw::MakeCanvas(const std::string &name)
{
  ...
  else if (name == "SepdMon4")
  {
    ...
    TC[3] = new TCanvas(name.c_str(), "sEPD Monitor 4 - Waveform Info", -1, 0, 600, 800);
    gSystem->ProcessEvents();
...
int SepdMonDraw::DrawFifth(const std::string & /* what */)
{
  ...
  // h1_packet_number->GetXaxis()->SetLabelSize(tsize);
  // h1_packet_number->GetYaxis()->SetLabelSize(tsize);
  // h1_packet_number->GetXaxis()->SetTitleSize(tsize);
  // h1_packet_number->GetYaxis()->SetTitleSize(tsize);
