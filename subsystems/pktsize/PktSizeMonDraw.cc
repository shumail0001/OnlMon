...
int
PktSizeMonDraw::Draw(const std::string &what)
{
  int iret = 0;
  int idraw = 0;
...
int
PktSizeMonDraw::SavePlot(const std::string &what, const std::string &type)
{
  OnlMonClient *cl = OnlMonClient::instance();
  int iret = Draw(what);
...
int
PktSizeMonDraw::MakeHtml(const std::string &what)
{
  // bbc
...
int
PktSizeMonDraw::DrawHistory(const std::string & /* what */)
{
