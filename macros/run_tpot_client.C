...
void tpotDrawInit(const int online = 0)
{
  ...
  for( const std::string& hname: { "m_adc_sample", "m_adc_channel", "m_counts_sample", "m_hit_charge", "m_hit_multiplicity", "m_wf_vs_channel", "m_hit_vs_channel", "m_heartbeat_vs_channel" } )
  {
