...
MessageSystem::MessageSystem(const string &name)
  : OnlMonBase(name)
{
...
int MessageSystem::send_message(const int msgsource, const int severity, const string &err_message, const int msgtype)
{
